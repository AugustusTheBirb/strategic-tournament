...
players = [str.allDove,str.allHawk,str.rando,str.copycat,str.conformist,str.critic,str.rebel] #add the strategies you want to play in the tournament to this list
