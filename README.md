...
The games are simultaneous - both strategies make the choice between the two actions at the same time, with their only knowledge being their previous history with eachother.
...
Either way, send it to my email: augustasrink@gmail.com
Or anywhere else doesn’t really matter
